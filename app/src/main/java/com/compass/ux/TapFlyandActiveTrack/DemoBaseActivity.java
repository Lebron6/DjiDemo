...
public class DemoBaseActivity extends FragmentActivity implements TextureView.SurfaceTextureListener {
    ...
    private void initPreviewer() {
        try {
            mProduct = TFDemoApplication.getProductInstance();
    ...
    private void uninitPreviewer() {
        Camera camera = TFDemoApplication.getCameraInstance();
        if (camera != null){
            // Reset the callback
    ...
    private void updateTitleBar() {
        ...
        boolean ret = false;
        BaseProduct product = TFDemoApplication.getProductInstance();
        if (product != null) {
            if(product.isConnected()) {
                mConnectStatusTextView.setText(TFDemoApplication.getProductInstance().getModel().getDisplayName() + " Connected");
                ret = true;
            } else {
