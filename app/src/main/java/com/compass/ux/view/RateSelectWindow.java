...
public class RateSelectWindow {
    ...
    public RateSelectWindow(Activity context) {
     ...
     * @param adapter
     */
    public  void showView(final View v, ArrayAdapter adapter,final OnRateSelectedListener listener) {
        View contentView = LayoutInflater.from(context).inflate(
                R.layout.window_rate, null);
        ...
        // 我觉得这里是API的一个bug
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.bg_zoom));
