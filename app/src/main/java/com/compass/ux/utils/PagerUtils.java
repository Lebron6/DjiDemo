...
public class PagerUtils {
    ...
    public final byte[] VERI130S = {0x00,0x00};//校验
    public final byte[] TAIL = {0x23};//帧尾

    public final byte[] TTSINS = {0x54};//文本指令
    public final byte[] TTSINS130S = {0x14};//文本指令
    ...
    public final byte[] TTSREPEATINSMP130S = {0x24,0x00,0x07,0x11,(byte)0xC2,0x00,0x23};//循环播放文本指令
    public final byte[] TTSONEINSMP130S = {0x24, 0x00, 0x07, 0x11, (byte)0xC1, 0x00, 0x23};//单次播放文本指令
    public final byte[] TTSSTOPINSMP130S = {0x24, 0x00, 0x07, 0x11, (byte) 0xF2, 0x00, 0x23};//文本停止

    //开灯
    public final  byte[] OPEN_LIGHT = {0x24,0x00,0x07,0x6A, (byte) 0xF1,0x00,0x23};
    //关灯
    public final  byte[] CLOSE_LIGHT = {0x24,0x00,0x07,0x6A, (byte) 0xF2,0x00,0x23};
    //接收到开灯状态
    public final  byte[] REC_OPEN_LIGHT = {0x24,0x00,0x07,0x6B, (byte) 0x01,0x00,0x23};
    //接收到关灯状态
    public final  byte[] REC_CLOSE_LIGHT = {0x24,0x00,0x07,0x6B, (byte) 0x00,0x00,0x23};


    public final byte[] LARGE={0x24, 0x00,0x07, 0x53,0x10,0x00,0x23};
    ...
    public byte[] dataCopy(byte[] ins, byte[] content) {
        byte[] size =intToBytes(6+ content.length);//包长转byte数组格式[0x00,0x0A],这里的6表示除了数据长度外,加上帧头帧尾指令位效验,MP130S应该是7
     ...
     * @return
     */
    public byte[] dataCopy130S(byte[] ins, byte[] content) {
...
//    public static byte[] TEST_TTS={0x24,0x00,0x08,0x13,0x00,0x28,0x00,0x23};
//    public static byte[] TEST_TTS_DATA={24002E1420E88081E593A5202D2D766F6963655F6E616D65207869616F79616E202D2D7370656564203530000023};
