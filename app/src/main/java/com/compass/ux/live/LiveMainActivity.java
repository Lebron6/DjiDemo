...
public class LiveMainActivity extends Activity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    private static final String TAG = LiveMainActivity.class.getName();
            ...
            camera.setSystemStateCallback(new SystemState.Callback() {
                ...
                public void onUpdate(@NonNull SystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        LiveMainActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private void initUI() {
        ...
        btn_battery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent intent = new Intent(LiveMainActivity.this, BattryActivity.class);
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(LiveMainActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
